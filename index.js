    ...
    if(status.action != null){
      switch(status.action){
        ...
        case 'removing':{
          ...
          twiml.message("Removed " + numbers.length == 0? 'no one': numbers + " from " + removingRoomName + ".\nThey have been notified you removed them.");
          updateStatus(req.body.From, null, null);
        }
        break;
      }
